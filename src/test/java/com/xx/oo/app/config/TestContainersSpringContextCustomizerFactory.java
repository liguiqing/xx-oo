...
public class TestContainersSpringContextCustomizerFactory implements ContextCustomizerFactory {
    ...
    private static KafkaTestContainer kafkaContainer;
        ...
        return (context, mergedConfig) -> {
            ...
            if (null != sqlAnnotation) {
                ...
                if (
                    ...
                    var jdbcUrl = devTestContainer.getTestContainer().getJdbcUrl();
                    testValues =
                        testValues.and(
                            "spring.datasource.url=" +
                            jdbcUrl.replace("jdbc", "jdbc:tc") +
            ...
            this.createKafka(testClass, testValues, beanFactory);
            testValues.applyTo(context);
        };
    }

    private void createKafka(Class<?> testClass, TestPropertyValues testValues, ConfigurableListableBeanFactory beanFactory) {
        ...
        if (null != kafkaAnnotation) {
            ...
            if (kafkaContainer == null) {
                ...
                beanFactory.initializeBean(kafkaContainer, KafkaTestContainer.class.getName().toLowerCase());
                beanFactory.registerSingleton(KafkaTestContainer.class.getName().toLowerCase(), kafkaContainer);
            ...
            testValues =
                testValues.and(
                    ...
                    kafkaContainer.getKafkaContainer().getHost() +
                    ':' +
                    kafkaContainer.getKafkaContainer().getMappedPort(KafkaContainer.KAFKA_PORT)
                );
        }
    }
}
