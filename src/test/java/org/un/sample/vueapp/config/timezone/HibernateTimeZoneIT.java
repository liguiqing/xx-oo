package org.un.sample.vueapp.config.timezone;
...
import org.un.sample.vueapp.repository.timezone.DateTimeWrapper;
import org.un.sample.vueapp.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM un_date_time_wrapper where id=%d", fieldName, id);
    }
