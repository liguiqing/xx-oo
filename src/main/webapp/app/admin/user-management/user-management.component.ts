...
export default class UnUserManagementComponent extends Vue {
    ...
    public deleteUser(): void {
        this.userManagementService()
            ...
            .then(res => {
                const message = this.$t(res.headers['x-vuesampleapp-alert'], {
                    param: decodeURIComponent(res.headers['x-vuesampleapp-params'].replace(/\+/g, ' ')),
                });
